...
class FiscalInfoService extends AbstractService
{
     ...
     * @param array<string, mixed>|null $payload
     */
    public function retrieveTaxInformation(
        array $pathParams = [],
        array $query = [],
        array $headers = [],
        ?array $payload = null
     ...
     * @param array<string, mixed>|null $payload
     */
    public function configureInvoiceIssuingPortal(
        array $pathParams = [],
        array $query = [],
        array $headers = [],
        ?array $payload = null
    ...
    public function listFederalServiceCodes(
        ...
        return $this->request(
            'GET',
            '/v3/fiscalInfo/federalServiceCodes',
            $pathParams,
            $query,
            $headers,
            $payload,
    ...
    public function listOperationIndicatorCodes(
        ...
        return $this->request(
            'GET',
            '/v3/fiscalInfo/operationIndicatorCodes',
            $pathParams,
            $query,
            $headers,
            $payload,
    ...
    public function listTaxSituationCodes(
        ...
        return $this->request(
            'GET',
            '/v3/fiscalInfo/taxSituationCodes',
            $pathParams,
            $query,
            $headers,
            $payload,
    ...
    public function listTaxClassificationCodes(
        ...
        return $this->request(
            'GET',
            '/v3/fiscalInfo/taxClassificationCodes',
            $pathParams,
            $query,
            $headers,
            $payload,
