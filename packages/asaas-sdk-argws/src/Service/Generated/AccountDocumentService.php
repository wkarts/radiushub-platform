...
class AccountDocumentService extends AbstractService
{
    /**
     ...
     * @param array<string, mixed>|null $payload
     */
    public function removeSentDocument(
        array $pathParams = [],
        array $query = [],
        array $headers = [],
        ?array $payload = null
     ...
     * @param array<string, mixed>|null $payload
     */
    public function viewDocumentSent(
        array $pathParams = [],
        array $query = [],
        array $headers = [],
        ?array $payload = null
     ...
     * @param array<string, mixed>|null $payload
     */
    public function updateSentDocument(
        array $pathParams = [],
        array $query = [],
        array $headers = [],
        ?array $payload = null
