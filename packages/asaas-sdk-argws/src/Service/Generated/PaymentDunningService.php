...
class PaymentDunningService extends AbstractService
{
    /**
     ...
     */
    public function createAPaymentDunning(
        array $pathParams = [],
        array $query = [],
        array $headers = [],
        ?array $payload = null
     ...
     * @param array<string, mixed>|null $payload
     */
    public function recoverASinglePaymentDunning(
        array $pathParams = [],
        array $query = [],
        array $headers = [],
        ?array $payload = null
     ...
     * @param array<string, mixed>|null $payload
     */
    public function simulateAPaymentDunning(
        array $pathParams = [],
        array $query = [],
        array $headers = [],
        ?array $payload = null
     ...
     * @param array<string, mixed>|null $payload
     */
    public function listPaymentsAvailableForPaymentDunning(
        array $pathParams = [],
        array $query = [],
        array $headers = [],
        ?array $payload = null
