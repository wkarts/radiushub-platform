...
class SubscriptionService extends AbstractService
{
     ...
     * @param array<string, mixed>|null $payload
     */
    public function retrieveASingleSubscription(
        array $pathParams = [],
        array $query = [],
        array $headers = [],
        ?array $payload = null
     ...
     * @param array<string, mixed>|null $payload
     */
    public function listPaymentsOfASubscription(
        array $pathParams = [],
        array $query = [],
        array $headers = [],
        ?array $payload = null
     ...
     * @param array<string, mixed>|null $payload
     */
    public function createConfigurationForIssuanceOfInvoices(
        array $pathParams = [],
        array $query = [],
        array $headers = [],
        ?array $payload = null
     ...
     * @param array<string, mixed>|null $payload
     */
    public function retrieveConfigurationForIssuanceOfInvoices(
        array $pathParams = [],
        array $query = [],
        array $headers = [],
        ?array $payload = null
     ...
     * @param array<string, mixed>|null $payload
     */
    public function updateConfigurationForIssuanceOfInvoices(
        array $pathParams = [],
        array $query = [],
        array $headers = [],
        ?array $payload = null
     ...
     * @param array<string, mixed>|null $payload
     */
    public function removeConfigurationForIssuanceOfInvoices(
        array $pathParams = [],
        array $query = [],
        array $headers = [],
        ?array $payload = null
