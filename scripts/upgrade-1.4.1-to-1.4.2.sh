...
backup="storage/app/deploy/upgrade-1.4.1-to-1.4.2-${stamp}"
...
echo "RadiusHub Platform atualizado para 1.4.2. Nenhuma migration nova foi adicionada. Backup: $backup"
echo "Docker: reconstrua a imagem FreeRADIUS para executar o parser 3.2.x durante o build."
