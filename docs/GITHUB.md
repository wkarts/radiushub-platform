...
A partir da versão 1.4.1, não é necessário criar a tag manualmente depois do merge.
...
```text
ghcr.io/wkarts/radiushub-app:1.4.1
ghcr.io/wkarts/radiushub-web:1.4.1
ghcr.io/wkarts/radiushub-freeradius:1.4.1
```
...
Depois de incorporar a versão 1.4.1, execute manualmente `Release automática` com:
