...
git init
git add .
git commit -m "feat: publicar RadiusHub Platform 1.2.0"
git branch -M main
...
```bash
git tag -a v1.2.0 -m "RadiusHub Platform 1.2.0"
...
```text
ghcr.io/wkarts/radiushub-app:1.2.0
ghcr.io/wkarts/radiushub-web:1.2.0
ghcr.io/wkarts/radiushub-freeradius:1.2.0
```
